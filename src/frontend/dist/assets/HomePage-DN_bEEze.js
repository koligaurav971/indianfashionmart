...
const Gem = createLucideIcon("gem", __iconNode$5);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Link,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-center text-xs font-medium text-foreground leading-tight", children: label }),
...
const howItWorks = [
  {
    ...
    description: "List your pre-loved sarees, clothing, or household items in minutes. Upload photos, set your price, and reach thousands of buyers."
  },
  {
    step: "02",
    icon: Search,
    title: "Browse Listings",
    description: "Discover unique finds at unbeatable prices. Filter by category, location, condition, and price range to find exactly what you need."
  },
  {
    step: "03",
    icon: MessageCircle,
    title: "Contact Seller",
    description: "Connect directly with sellers through our secure messaging. Negotiate, ask questions, and close the deal safely."
  }
];
function HomePage() {
  var _a;
  ...
  const [selectedCity, setSelectedCity] = reactExports.useState("All India");
  const { data: featured, isLoading } = useQuery({
    queryKey: ["featured-listings"],
    queryFn: async () => actor == null ? void 0 : actor.getFeaturedListings(BigInt(0), BigInt(8)),
    enabled: isReady
  });
  function handleSearch(e) {
    ...
    navigate({
      to: "/search",
      search: {
        keyword: searchQuery || void 0,
        location: selectedCity === "All India" ? void 0 : selectedCity,
        category: void 0,
        condition: void 0,
        minPrice: void 0,
        maxPrice: void 0,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", children: [
      ...
      "section",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 z-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-background/95 via-background/70 to-background/20" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 mx-auto max-w-screen-xl px-4 py-14 md:py-24", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                ...
                className: "max-w-xl",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5 rounded-full border border-primary/30 bg-primary/10 px-3 py-1 text-xs font-semibold text-primary mb-4", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { className: "h-3.5 w-3.5" }),
                    "India's Trusted Marketplace"
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-4xl font-bold leading-tight text-foreground md:text-6xl", children: [
                    "Buy & Sell ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Anything" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-base text-foreground/80 md:text-lg max-w-md", children: "From pre-loved sarees to electronics — find great deals near you or turn your unused items into cash." })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.form,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex-shrink-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-accent" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "select",
                      {
                        value: selectedCity,
                        ...
                        children: CITIES.map((city) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: city, children: city }, city))
                      }
                    )
                  ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/listings", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Button,
                    {
                      size: "lg",
                      variant: "outline",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/sell", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Button,
                    {
                      size: "lg",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-screen-xl px-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-7 flex items-end justify-between", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-foreground md:text-3xl", children: "Shop by Category" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1.5 h-1 w-12 rounded-full bg-primary" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-4 gap-3 sm:grid-cols-8", children: categories.map((cat, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(CategoryCard, { ...cat })
            },
            cat.value
          )) })
        ] })
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-screen-xl px-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-7 flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-foreground md:text-3xl", children: "Featured Listings" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1.5 h-1 w-12 rounded-full bg-accent" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Link,
              {
          ...
          isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingSkeleton, { variant: "card", count: 8, className: "contents" })
            }
          ) : !((_a = featured == null ? void 0 : featured.items) == null ? void 0 : _a.length) ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            EmptyState,
            {
          ...
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4", children: featured.items.map((listing, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              initial: { opacity: 0, y: 20 },
              whileInView: { opacity: 1, y: 0 },
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(ListingCard, { listing, index: i, className: "h-full" })
            },
            String(listing.id)
          )) })
        ] })
      ...
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-screen-xl px-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-10 text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-foreground md:text-3xl", children: "How It Works" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto mt-1.5 h-1 w-12 rounded-full bg-primary" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm text-muted-foreground", children: "Three simple steps to buy or sell anything" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-8 md:grid-cols-3", children: howItWorks.map(({ step, icon: Icon, title, description }, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "absolute -top-3 left-1/2 -translate-x-1/2 rounded-full bg-primary px-3 py-0.5 text-xs font-bold text-primary-foreground", children: [
                  "Step ",
                  step
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-16 w-16 items-center justify-center rounded-2xl bg-accent/15 text-accent", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "h-8 w-8" }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-screen-xl px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-6 text-center md:grid-cols-4", children: [
        ...
        ].map(({ num, label }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-2xl font-bold text-primary md:text-3xl", children: num }),
